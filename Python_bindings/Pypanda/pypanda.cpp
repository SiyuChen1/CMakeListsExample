...
void libfranka_bindings(py::module &m) {
  // map exceptions to python (Exceptions are named with Error in Python):
  py::register_exception<franka::Exception>(m, "GeneralError");
  py::register_exception<franka::CommandException>(m, "CommandError");
  py::register_exception<franka::ControlException>(m, "ControlError");
  py::register_exception<franka::IncompatibleVersionException>(m, "IncompatibleVersionError");
  py::register_exception<franka::InvalidOperationException>(m, "InvalidOperationError");
  py::register_exception<franka::ModelException>(m, "ModelError");
  py::register_exception<franka::NetworkException>(m, "NetworkError");
  py::register_exception<franka::ProtocolException>(m, "ProtocolError");
  py::register_exception<franka::RealtimeException>(m, "RealtimenError");

  py::class_<franka::Errors>(m, "Errors")
      .def(py::init<const std::array<bool, 37> &>(), py::arg("errors"))
      .def(
          "hasAnyError",
          +[](const franka::Errors *self) -> bool { return static_cast<bool>(*self); })
      .def(
          "__repr__",
          +[](const franka::Errors *self) -> std::string {
            return static_cast<std::string>(*self);
          })
      // Needs to be a function, found no other way to access const reference member otherwise
      .def(
          "joint_position_limits_violation",
          +[](const franka::Errors *self) -> bool { return self->joint_position_limits_violation; })
      .def(
          "cartesian_position_limits_violation",
          +[](const franka::Errors *self) -> bool {
            return self->cartesian_position_limits_violation;
          })
      .def(
          "self_collision_avoidance_violation",
          +[](const franka::Errors *self) -> bool {
            return self->self_collision_avoidance_violation;
          })
      .def(
          "joint_velocity_violation",
          +[](const franka::Errors *self) -> bool { return self->joint_velocity_violation; })
      .def(
          "cartesian_velocity_violation",
          +[](const franka::Errors *self) -> bool { return self->cartesian_velocity_violation; })
      .def(
          "force_control_safety_violation",
          +[](const franka::Errors *self) -> bool { return self->force_control_safety_violation; })
      .def(
          "joint_reflex", +[](const franka::Errors *self) -> bool { return self->joint_reflex; })
      .def(
          "cartesian_reflex",
          +[](const franka::Errors *self) -> bool { return self->cartesian_reflex; })
      .def(
          "max_goal_pose_deviation_violation",
          +[](const franka::Errors *self) -> bool {
            return self->max_goal_pose_deviation_violation;
          })
      .def(
          "max_path_pose_deviation_violation",
          +[](const franka::Errors *self) -> bool {
            return self->max_path_pose_deviation_violation;
          })
      .def(
      ...
      .def(
          ...
          +[](const franka::Errors *self) -> bool { return self->controller_torque_discontinuity; })
      .def(
          "start_elbow_sign_inconsistent",
          +[](const franka::Errors *self) -> bool { return self->start_elbow_sign_inconsistent; })
      .def(
          "communication_constraints_violation",
          +[](const franka::Errors *self) -> bool {
            return self->communication_constraints_violation;
          })
      .def(
          "power_limit_violation",
          +[](const franka::Errors *self) -> bool { return self->power_limit_violation; })
      .def(
      ...
      .def(
          ...
          +[](const franka::Errors *self) -> bool { return self->tau_j_range_violation; })
      .def(
          "instability_detected",
          +[](const franka::Errors *self) -> bool { return self->instability_detected; })
      .def(
          "joint_move_in_wrong_direction",
          +[](const franka::Errors *self) -> bool { return self->joint_move_in_wrong_direction; });
  ...
  m.def("MotionFinished", py::overload_cast<franka::JointVelocities>(&franka::MotionFinished),
